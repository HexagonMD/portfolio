...
筑波大学大学院 情報理工学位プログラムで、自律型攻撃エージェントやAIエージェントの研究に取り組んでいます。  
就業型インターンでは、PLAIDでのAIチャット機能開発、CARTA HOLDINGSでのセキュリティエンジニア業務を通じて、セキュリティを事業・開発に横断して活かせるポータブルスキルとして磨いています。
