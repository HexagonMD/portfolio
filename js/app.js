...
const ACTIVITIES = [
    {
        ...
        endDate: '2026-07-31',
        category: 'intern',
        title: '株式会社CARTA HOLDINGS セキュリティエンジニア',
        description: 'LLMと静的解析を組み合わせ、複数リポジトリを横断してセキュリティリスクを発見・評価・説明する診断ハーネスのPoCを研究開発。候補箇所の文脈整理、再現可能な検証手順の生成、事業・サービス・アーキテクチャ上の観点を含むトリアージレポート化に取り組む予定。',
        link: 'https://cartaholdings.co.jp/',
    },
    {
        date: '2025-12-01',
        endDate: '2026-05-31',
        ...
        description: '半年間のインターンとして、自社AIチャットのエージェント設計・実装に従事。トークン数削減・回答精度向上のためのバックエンドツールやワーキングメモリの開発、広告媒体コネクタの機能開発・改善を担当。',
        link: null,
    },
    {
        date: '2025-10-27',
    ...
    },
    {
        ...
        description: '3/26〜29の4日間、AIレッドチーミングクラスにチューターとして参加。LLMやマルチエージェントシステムに内在するセキュリティ課題を扱い、プロンプトインジェクションやエージェント間通信の脅威を座学と実践で再現・分析するクラス。',
    ...
    },
    {
        ...
        title: '東京電機大学 システムデザイン工学部 学部長賞 受賞',
        description: '大学生活4年間の学業成績・研究・課外活動に対する評価をいただき、システムデザイン工学部 学部長賞を受賞しました。',
        link: null,
    },
    {
        date: '2025-10-05',
